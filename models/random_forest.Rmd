...
for (first_test_yr in 1998:2020){
  ...
  wheat_test <- window(ts(corn_embed_tst,start=1938), start=first_test_yr+1,end=first_test_yr+horizon)
  ...
  soy_row <- c(first_test_yr, "wheat",rf_predictions(soy_train, soy_test),soy_test[0:horizon])
